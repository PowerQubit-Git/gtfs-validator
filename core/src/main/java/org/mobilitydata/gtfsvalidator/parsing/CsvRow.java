...
public class CsvRow {
   ...
   *
   * <p>Returns {@code null} in the following cases: - the column index is out of bounds - column
   * value is not defined - column value is an empty string ""
   *
   * <p>Example.
   *
   * <p>col0,col1,col2 a,,""
   *
   * <p>asString(0) == "a" asString(1) == null (no value specified) asString(2) == null (explicit
  ...
  public String asString(int columnIndex) {
    ...
    // Univocity CSV parser already returns null for no explicit value and for an explicit empty
    // string "".
