...
import org.mobilitydata.gtfsvalidator.parsing.*;
...
import static org.mobilitydata.gtfsvalidator.FieldNameConverter.*;
...
public class TableLoaderGenerator {
  ...
  public JavaFile generateGtfsTableLoaderJavaFile() {
    return JavaFile.builder(GtfsEntityClasses.TABLE_PACKAGE_NAME, generateGtfsTableLoaderClass()).build();
  }
